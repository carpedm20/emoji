...
EMOJI_UNICODE_SPANISH = {
    ...
    u':cara_con_el_ceño_fruncido:': u'\U00002639',
    ...
    u':calavera_y_huesos_cruzados:': u'\U00002620',
    ...
    u':exclamación_de_corazón:': u'\U00002763',
    u':corazón_roto:': u'\U0001F494',
    u':corazón_rojo:': u'\U00002764',
    ...
    u':bocadillo_de_diálogo_por_la_izquierda:': u'\U0001F5E8',
    u':bocadillo_de_enfado_por_la_derecha:': u'\U0001F5EF',
    ...
    u':mano_escribiendo:': u'\U0000270D',
    ...
    u':hombre_trajeado_levitando:': u'\U0001F574',
    ...
    u':persona_botando_un_balón:': u'\U000026F9',
    ...
    u':persona_levantando_pesas:': u'\U0001F3CB',
    ...
    u':cuchillo_y_tenedor_con_un_plato:': u'\U0001F37D',
    ...
    u':coche_de_carreras:': u'\U0001F3CE',
    u':moto:': u'\U0001F3CD',
    ...
    u':vía_de_tren:': u'\U0001F6E4',
    u':barril_de_petróleo:': u'\U0001F6E2',
    ...
    u':barco_de_pasajeros:': u'\U0001F6F3',
    u':ferri:': u'\U000026F4',
    u':barco_a_motor:': u'\U0001F6E5',
    u':barco:': u'\U0001F6A2',
    u':avión:': u'\U00002708',
    u':avioneta:': u'\U0001F6E9',
    ...
    u':cronómetro:': u'\U000023F1',
    u':temporizador:': u'\U000023F2',
    u':reloj_de_sobremesa:': u'\U0001F570',
    ...
    u':nube_con_rayo_y_lluvia:': u'\U000026C8',
    u':sol_detrás_de_una_nube_pequeña:': u'\U0001F324',
    u':sol_detrás_de_una_nube_grande:': u'\U0001F325',
    u':sol_detrás_de_una_nube_con_lluvia:': u'\U0001F326',
    u':nube_con_lluvia:': u'\U0001F327',
    u':nube_con_nieve:': u'\U0001F328',
    u':nube_con_rayo:': u'\U0001F329',
    u':tornado:': u'\U0001F32A',
    u':niebla:': u'\U0001F32B',
    u':cara_de_viento:': u'\U0001F32C',
    ...
    u':sombrilla_en_la_arena:': u'\U000026F1',
    u':alto_voltaje:': u'\U000026A1',
    u':copo_de_nieve:': u'\U00002744',
    u':muñeco_de_nieve_con_nieve:': u'\U00002603',
    u':muñeco_de_nieve:': u'\U000026C4',
    u':meteorito:': u'\U00002604',
    u':fuego:': u'\U0001F525',
    u':gota:': u'\U0001F4A7',
    ...
    u':lazo_conmemorativo:': u'\U0001F397',
    u':entradas:': u'\U0001F39F',
    u':tique:': u'\U0001F3AB',
    u':medalla_militar:': u'\U0001F396',
    ...
    u':palo_de_picas:': u'\U00002660',
    u':palo_de_corazones:': u'\U00002665',
    u':palo_de_diamantes:': u'\U00002666',
    u':palo_de_tréboles:': u'\U00002663',
    u':peón_de_ajedrez:': u'\U0000265F',
    u':comodín:': u'\U0001F0CF',
    u':dragón_rojo_de_mahjong:': u'\U0001F004',
    u':cartas_de_flores:': u'\U0001F3B4',
    u':máscaras_de_teatro:': u'\U0001F3AD',
    u':cuadro_enmarcado:': u'\U0001F5BC',
    ...
    u':bolsas_de_compras:': u'\U0001F6CD',
    ...
    u':casco_con_una_cruz_blanca:': u'\U000026D1',
    ...
    u':micrófono_de_estudio:': u'\U0001F399',
    u':control_de_volumen:': u'\U0001F39A',
    u':ruedas_de_control:': u'\U0001F39B',
    ...
    u':ordenador_de_sobremesa:': u'\U0001F5A5',
    u':impresora:': u'\U0001F5A8',
    u':teclado:': u'\U00002328',
    u':ratón_de_ordenador:': u'\U0001F5B1',
    u':bola_de_desplazamiento:': u'\U0001F5B2',
    ...
    u':fotograma_de_película:': u'\U0001F39E',
    u':proyector_de_cine:': u'\U0001F4FD',
    ...
    u':periódico_enrollado:': u'\U0001F5DE',
    ...
    u':buzón:': u'\U0001F4EE',
    u':urna_con_papeleta:': u'\U0001F5F3',
    u':lápiz:': u'\U0000270F',
    u':pluma_negra:': u'\U00002712',
    u':estilográfica:': u'\U0001F58B',
    u':bolígrafo:': u'\U0001F58A',
    u':pincel:': u'\U0001F58C',
    u':lápiz_de_cera:': u'\U0001F58D',
    ...
    u':separador_de_fichas:': u'\U0001F5C2',
    u':calendario:': u'\U0001F4C5',
    u':calendario_recortable:': u'\U0001F4C6',
    u':bloc_de_notas_de_espiral:': u'\U0001F5D2',
    u':calendario_de_espiral:': u'\U0001F5D3',
    ...
    u':clip:': u'\U0001F4CE',
    u':clips_unidos:': u'\U0001F587',
    u':regla:': u'\U0001F4CF',
    u':escuadra:': u'\U0001F4D0',
    u':tijeras:': u'\U00002702',
    u':archivador_de_tarjetas:': u'\U0001F5C3',
    ...
    u':llave:': u'\U0001F511',
    u':llave_antigua:': u'\U0001F5DD',
    u':martillo:': u'\U0001F528',
    u':hacha:': u'\U0001FA93',
    u':pico:': u'\U000026CF',
    u':martillo_y_pico:': u'\U00002692',
    u':martillo_y_llave_inglesa:': u'\U0001F6E0',
    u':puñal:': u'\U0001F5E1',
    u':espadas_cruzadas:': u'\U00002694',
    ...
    u':tornillo_de_banco:': u'\U0001F5DC',
    ...
    u':radiactivo:': u'\U00002622',
    u':riesgo_biológico:': u'\U00002623',
    u':flecha_hacia_arriba:': u'\U00002B06',
    u':flecha_hacia_la_esquina_superior_derecha:': u'\U00002197',
    u':flecha_hacia_la_derecha:': u'\U000027A1',
    u':flecha_hacia_la_esquina_inferior_derecha:': u'\U00002198',
    u':flecha_hacia_abajo:': u'\U00002B07',
    u':flecha_hacia_la_esquina_inferior_izquierda:': u'\U00002199',
    u':flecha_hacia_la_izquierda:': u'\U00002B05',
    u':flecha_hacia_la_esquina_superior_izquierda:': u'\U00002196',
    u':flecha_arriba_y_abajo:': u'\U00002195',
    u':flecha_izquierda_y_derecha:': u'\U00002194',
    u':flecha_derecha_curvándose_a_la_izquierda:': u'\U000021A9',
    u':flecha_izquierda_curvándose_a_la_derecha:': u'\U000021AA',
    u':flecha_derecha_curvándose_hacia_arriba:': u'\U00002934',
    u':flecha_derecha_curvándose_hacia_abajo:': u'\U00002935',
    ...
    u':símbolo_de_átomo:': u'\U0000269B',
    u':om:': u'\U0001F549',
    u':estrella_de_david:': u'\U00002721',
    u':rueda_del_dharma:': u'\U00002638',
    u':yin_yang:': u'\U0000262F',
    u':cruz_latina:': u'\U0000271D',
    u':cruz_ortodoxa:': u'\U00002626',
    u':media_luna_y_estrella:': u'\U0000262A',
    u':símbolo_de_la_paz:': u'\U0000262E',
    ...
    u':reproducir:': u'\U000025B6',
    u':avance_rápido:': u'\U000023E9',
    u':pista_siguiente:': u'\U000023ED',
    u':reproducir_o_pausa:': u'\U000023EF',
    u':retroceso:': u'\U000025C0',
    u':rebobinado:': u'\U000023EA',
    u':pista_anterior:': u'\U000023EE',
    ...
    u':pausa:': u'\U000023F8',
    u':detener:': u'\U000023F9',
    u':grabar:': u'\U000023FA',
    u':expulsar:': u'\U000023CF',
    u':cine:': u'\U0001F3A6',
    ...
    u':signo_femenino:': u'\U00002640',
    u':signo_masculino:': u'\U00002642',
    u':símbolo_de_transgénero:': u'\U000026A7',
    u':multiplicación:': u'\U00002716',
    u':más:': u'\U00002795',
    u':menos:': u'\U00002796',
    u':división:': u'\U00002797',
    u':infinito:': u'\U0000267E',
    u':exclamación_doble:': u'\U0000203C',
    u':exclamación_e_interrogación:': u'\U00002049',
    ...
    u':guion_ondulado:': u'\U00003030',
    u':cambio_de_divisas:': u'\U0001F4B1',
    u':símbolo_de_dólar:': u'\U0001F4B2',
    u':símbolo_de_medicina:': u'\U00002695',
    u':símbolo_de_reciclaje:': u'\U0000267B',
    u':flor_de_lis:': u'\U0000269C',
    ...
    u':casilla_con_marca_de_verificación:': u'\U00002611',
    u':marca_de_verificación:': u'\U00002714',
    u':marca_de_cruz:': u'\U0000274C',
    u':botón_con_marca_de_cruz:': u'\U0000274E',
    u':bucle:': u'\U000027B0',
    u':bucle_doble:': u'\U000027BF',
    u':marca_de_alternancia:': u'\U0000303D',
    u':asterisco_de_ocho_puntas:': u'\U00002733',
    u':estrella_de_ocho_puntas:': u'\U00002734',
    u':chispa:': u'\U00002747',
    u':copyright:': u'\U000000A9',
    u':marca_registrada:': u'\U000000AE',
    u':símbolo_de_marca_comercial:': u'\U00002122',
    ...
    u':grupo_sanguíneo_a:': u'\U0001F170',
    u':grupo_sanguíneo_ab:': u'\U0001F18E',
    u':grupo_sanguíneo_b:': u'\U0001F171',
    ...
    u':m_en_círculo:': u'\U000024C2',
    u':botón_new:': u'\U0001F195',
    u':botón_ng:': u'\U0001F196',
    u':grupo_sanguíneo_tipo_o:': u'\U0001F17E',
    u':botón_ok:': u'\U0001F197',
    u':aparcamiento:': u'\U0001F17F',
    u':símbolo_de_socorro:': u'\U0001F198',
    u':botón_up!:': u'\U0001F199',
    u':botón_vs:': u'\U0001F19A',
    u':ideograma_japonés_para_aquí:': u'\U0001F201',
    u':ideograma_japonés_para_de_cortesía:': u'\U0001F202',
    u':ideograma_japonés_para_cantidad_mensual:': u'\U0001F237',
    ...
    u':ideograma_japonés_para_enhorabuena:': u'\U00003297',
    u':ideograma_japonés_para_secreto:': u'\U00003299',
    ...
    u':cuadrado_negro_mediano:': u'\U000025FC',
    u':cuadrado_blanco_mediano:': u'\U000025FB',
    u':cuadrado_negro_mediano-pequeño:': u'\U000025FE',
    u':cuadrado_blanco_mediano-pequeño:': u'\U000025FD',
    u':cuadrado_negro_pequeño:': u'\U000025AA',
    u':cuadrado_blanco_pequeño:': u'\U000025AB',
