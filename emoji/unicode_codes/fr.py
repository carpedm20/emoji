...
EMOJI_UNICODE_FRENCH = {
    ...
    u':visage_mécontent:': u'\U00002639',
    ...
    u':cœur_point_d’exclamation:': u'\U00002763',
    u':cœur_brisé:': u'\U0001F494',
    u':cœur_rouge:': u'\U00002764',
    ...
    u':bulle_de_parole_gauche:': u'\U0001F5E8',
    u':bulle_colère_droite:': u'\U0001F5EF',
    ...
    u':main_levée_doigts_écartés:': u'\U0001F590',
    ...
    u':v_de_la_victoire:': u'\U0000270C',
    ...
    u':index_pointant_vers_le_haut:': u'\U0000261D',
    ...
    u':homme_d’affaires_en_lévitation:': u'\U0001F574',
    ...
    u':personne_avec_ballon:': u'\U000026F9',
    ...
    u':toile_d’araignée:': u'\U0001F578',
    ...
    u':fourchette_et_couteau_avec_assiette:': u'\U0001F37D',
    ...
    u':carte_du_monde:': u'\U0001F5FA',
    u':carte_du_japon:': u'\U0001F5FE',
    u':boussole:': u'\U0001F9ED',
    u':montagne_enneigée:': u'\U0001F3D4',
    u':montagne:': u'\U000026F0',
    u':volcan:': u'\U0001F30B',
    u':mont_fuji:': u'\U0001F5FB',
    u':camping:': u'\U0001F3D5',
    u':plage_avec_parasol:': u'\U0001F3D6',
    u':désert:': u'\U0001F3DC',
    u':île_déserte:': u'\U0001F3DD',
    u':parc_national:': u'\U0001F3DE',
    u':stade:': u'\U0001F3DF',
    u':monument_classique:': u'\U0001F3DB',
    u':construction_d’un_bâtiment:': u'\U0001F3D7',
    u':brique:': u'\U0001F9F1',
    u':rocher:': u'\U0001FAA8',
    u':bois:': u'\U0001FAB5',
    u':hutte:': u'\U0001F6D6',
    u':maisons:': u'\U0001F3D8',
    u':maison_abandonnée:': u'\U0001F3DA',
    ...
    u':sanctuaire_shinto:': u'\U000026E9',
    u':kaaba:': u'\U0001F54B',
    ...
    u':voiture_de_course:': u'\U0001F3CE',
    u':moto:': u'\U0001F3CD',
    ...
    u':voie_ferrée:': u'\U0001F6E4',
    u':baril_de_pétrole:': u'\U0001F6E2',
    ...
    u':paquebot:': u'\U0001F6F3',
    u':ferry:': u'\U000026F4',
    u':bateau_à_moteur:': u'\U0001F6E5',
    u':navire:': u'\U0001F6A2',
    u':avion:': u'\U00002708',
    u':petit_avion:': u'\U0001F6E9',
    ...
    u':cloche_de_comptoir:': u'\U0001F6CE',
    ...
    u':horloge:': u'\U000023F2',
    u':pendule:': u'\U0001F570',
    ...
    u':nuage_avec_éclair_et_pluie:': u'\U000026C8',
    u':soleil_derrière_un_petit_nuage:': u'\U0001F324',
    u':soleil_derrière_un_gros_nuage:': u'\U0001F325',
    u':soleil_derrière_un_nuage_de_pluie:': u'\U0001F326',
    u':nuage_avec_pluie:': u'\U0001F327',
    u':nuage_avec_neige:': u'\U0001F328',
    u':nuage_avec_éclair:': u'\U0001F329',
    u':tornade:': u'\U0001F32A',
    u':brouillard:': u'\U0001F32B',
    u':vent_avec_visage:': u'\U0001F32C',
    u':cyclone:': u'\U0001F300',
    u':arc-en-ciel:': u'\U0001F308',
    u':parapluie_fermé:': u'\U0001F302',
    u':parapluie_ouvert:': u'\U00002602',
    u':parapluie_avec_gouttes_de_pluie:': u'\U00002614',
    u':parasol_sur_le_sol:': u'\U000026F1',
    u':symbole_de_haute_tension:': u'\U000026A1',
    u':flocon:': u'\U00002744',
    u':bonhomme_de_neige:': u'\U00002603',
    ...
    u':ruban_de_mémoire:': u'\U0001F397',
    u':billet_d’entrée:': u'\U0001F39F',
    u':billet:': u'\U0001F3AB',
    u':médaille_militaire:': u'\U0001F396',
    ...
    u':pique:': u'\U00002660',
    u':cœur_cartes:': u'\U00002665',
    u':carreau:': u'\U00002666',
    u':trèfle_cartes:': u'\U00002663',
    u':pion_d’échec:': u'\U0000265F',
    u':carte_joker:': u'\U0001F0CF',
    u':dragon_rouge_mahjong:': u'\U0001F004',
    u':jeu_des_fleurs:': u'\U0001F3B4',
    u':spectacle_vivant:': u'\U0001F3AD',
    u':cadre_avec_image:': u'\U0001F5BC',
    ...
    u':lunettes_de_soleil:': u'\U0001F576',
    ...
    u':sacs_de_shopping:': u'\U0001F6CD',
    ...
    u':casque_de_secouriste:': u'\U000026D1',
    ...
    u':micro_de_studio:': u'\U0001F399',
    u':curseur_de_niveau:': u'\U0001F39A',
    u':boutons_de_réglage:': u'\U0001F39B',
    u':micro:': u'\U0001F3A4',
    ...
    u':ordinateur_de_bureau:': u'\U0001F5A5',
    u':imprimante:': u'\U0001F5A8',
    u':clavier:': u'\U00002328',
    u':souris_d’ordinateur:': u'\U0001F5B1',
    u':boule_de_commande:': u'\U0001F5B2',
    ...
    u':pellicule:': u'\U0001F39E',
    u':projecteur_cinématographique:': u'\U0001F4FD',
    u':clap:': u'\U0001F3AC',
    ...
    u':urne_électorale:': u'\U0001F5F3',
    u':crayon:': u'\U0000270F',
    u':stylo_plume_noir:': u'\U00002712',
    u':stylo_plume:': u'\U0001F58B',
    u':stylo:': u'\U0001F58A',
    u':pinceau:': u'\U0001F58C',
    u':crayon_pastel:': u'\U0001F58D',
    u':mémo:': u'\U0001F4DD',
    u':porte-documents:': u'\U0001F4BC',
    u':dossier:': u'\U0001F4C1',
    u':dossier_ouvert:': u'\U0001F4C2',
    u':intercalaires:': u'\U0001F5C2',
    u':calendrier:': u'\U0001F4C5',
    u':éphéméride:': u'\U0001F4C6',
    u':bloc-notes_à_spirale:': u'\U0001F5D2',
    u':calendrier_à_spirale:': u'\U0001F5D3',
    ...
    u':trombones:': u'\U0001F587',
    u':règle:': u'\U0001F4CF',
    u':équerre:': u'\U0001F4D0',
    u':ciseaux:': u'\U00002702',
    u':boîte_à_dossiers:': u'\U0001F5C3',
    u':meuble_à_dossiers:': u'\U0001F5C4',
    u':corbeille_à_papiers:': u'\U0001F5D1',
    ...
    u':clé:': u'\U0001F511',
    u':clé_ancienne:': u'\U0001F5DD',
    u':marteau:': u'\U0001F528',
    u':hache:': u'\U0001FA93',
    u':pioche:': u'\U000026CF',
    u':marteau_et_pioche:': u'\U00002692',
    u':marteau_et_clé_à_molette:': u'\U0001F6E0',
    u':dague:': u'\U0001F5E1',
    u':épées_croisées:': u'\U00002694',
    ...
    u':roue_dentée:': u'\U00002699',
    u':serre-joint:': u'\U0001F5DC',
    u':balance_à_poids:': u'\U00002696',
    ...
    u':symbole_d’avertissement:': u'\U000026A0',
    ...
    u':danger_biologique:': u'\U00002623',
    u':flèche_haut:': u'\U00002B06',
    u':flèche_haut_droite:': u'\U00002197',
    u':flèche_droite:': u'\U000027A1',
    u':flèche_bas_droite:': u'\U00002198',
    u':flèche_bas:': u'\U00002B07',
    u':flèche_bas_gauche:': u'\U00002199',
    u':flèche_gauche:': u'\U00002B05',
    u':flèche_haut_gauche:': u'\U00002196',
    u':flèche_haut_bas:': u'\U00002195',
    u':flèche_gauche_droite:': u'\U00002194',
    u':flèche_courbe_gauche:': u'\U000021A9',
    u':flèche_courbe_droite:': u'\U000021AA',
    u':flèche_courbe_haut:': u'\U00002934',
    u':flèche_courbe_bas:': u'\U00002935',
    ...
    u':symbole_de_l’atome:': u'\U0000269B',
    u':om:': u'\U0001F549',
    u':étoile_de_david:': u'\U00002721',
    u':roue_du_dharma:': u'\U00002638',
    u':yin_yang:': u'\U0000262F',
    u':croix_latine:': u'\U0000271D',
    u':croix_orthodoxe:': u'\U00002626',
    u':lune_et_étoile:': u'\U0000262A',
    u':symbole_de_paix:': u'\U0000262E',
    ...
    u':bouton_lecture:': u'\U000025B6',
    u':bouton_avance_rapide:': u'\U000023E9',
    u':bouton_piste_suivante:': u'\U000023ED',
    u':bouton_lecture/pause:': u'\U000023EF',
    u':bouton_retour:': u'\U000025C0',
    u':bouton_retour_rapide:': u'\U000023EA',
    u':bouton_piste_précédente:': u'\U000023EE',
    ...
    u':bouton_pause:': u'\U000023F8',
    u':bouton_stop:': u'\U000023F9',
    u':bouton_enregistrer:': u'\U000023FA',
    u':bouton_éjecter:': u'\U000023CF',
    ...
    u':symbole_de_la_femme:': u'\U00002640',
    u':symbole_de_l’homme:': u'\U00002642',
    u':symbole_de_la_communauté_transgenre:': u'\U000026A7',
    u':signe_multiplier:': u'\U00002716',
    u':signe_plus:': u'\U00002795',
    u':signe_moins:': u'\U00002796',
    u':signe_diviser:': u'\U00002797',
    u':infini:': u'\U0000267E',
    u':double_point_d’exclamation:': u'\U0000203C',
    u':points_d’exclamation_et_d’interrogation:': u'\U00002049',
    ...
    u':ligne_ondulée:': u'\U00003030',
    u':conversion_de_devise:': u'\U0001F4B1',
    u':dollar:': u'\U0001F4B2',
    u':caducée:': u'\U00002695',
    u':symbole_recyclage:': u'\U0000267B',
    u':fleur_de_lys:': u'\U0000269C',
    ...
    u':case_cochée:': u'\U00002611',
    u':coche:': u'\U00002714',
    u':croix:': u'\U0000274C',
    u':bouton_croix:': u'\U0000274E',
    u':boucle:': u'\U000027B0',
    u':double_boucle:': u'\U000027BF',
    u':alternance:': u'\U0000303D',
    u':astérisque_huit_branches:': u'\U00002733',
    u':étoile_huit_branches:': u'\U00002734',
    u':éclat:': u'\U00002747',
    u':symbole_copyright:': u'\U000000A9',
    u':marque_déposée:': u'\U000000AE',
    u':marque_commerciale_déposée:': u'\U00002122',
    ...
    u':bouton_félicitations_en_japonais:': u'\U00003297',
    u':bouton_secret_en_japonais:': u'\U00003299',
    ...
    u':carré_moyen_noir:': u'\U000025FC',
    u':carré_moyen_blanc:': u'\U000025FB',
    u':carré_petit_moyen_noir:': u'\U000025FE',
    u':carré_petit_moyen_blanc:': u'\U000025FD',
    u':petit_carré_noir:': u'\U000025AA',
    u':petit_carré_blanc:': u'\U000025AB',
