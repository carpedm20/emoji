...
EMOJI_UNICODE_GERMAN = {
	...
	u':düsteres_gesicht:': u'\U00002639',
	...
	u':totenkopf_mit_gekreuzten_knochen:': u'\U00002620',
	...
	u':herz_als_ausrufezeichen:': u'\U00002763',
	...
	u':sprechblase_links:': u'\U0001F5E8',
	u':sprechblase_für_wütende_aussage_rechts:': u'\U0001F5EF',
	...
	u':nach_oben_weisender_zeigefinger_von_vorne:': u'\U0000261D',
	...
	u':schreibende_hand:': u'\U0000270D',
	...
	u':schwebender_mann_im_anzug:': u'\U0001F574',
	...
	u':hase:': u'\U0001F407',
	u':streifenhörnchen:': u'\U0001F43F',
	u':biber:': u'\U0001F9AB',
	u':igel:': u'\U0001F994',
	...
	u':teller_mit_messer_und_gabel:': u'\U0001F37D',
	...
	u':antikes_gebäude:': u'\U0001F3DB',
	u':kran:': u'\U0001F3D7',
	u':ziegelstein:': u'\U0001F9F1',
	u':felsen:': u'\U0001FAA8',
	u':holz:': u'\U0001FAB5',
	u':hütte:': u'\U0001F6D6',
	u':wohnhäuser:': u'\U0001F3D8',
	u':verfallenes_haus:': u'\U0001F3DA',
	u':haus:': u'\U0001F3E0',
	...
	u':bahngleis:': u'\U0001F6E4',
	u':ölfass:': u'\U0001F6E2',
	...
	u':rezeptionsklingel:': u'\U0001F6CE',
	...
	u':aufgestellter_sonnenschirm:': u'\U000026F1',
	u':hochspannung:': u'\U000026A1',
	u':schneeflocke:': u'\U00002744',
	u':schneemann_im_schnee:': u'\U00002603',
	...
	u':gedenkschleife:': u'\U0001F397',
	u':eintrittskarten:': u'\U0001F39F',
	u':ticket:': u'\U0001F3AB',
	u':militärorden:': u'\U0001F396',
	u':pokal:': u'\U0001F3C6',
	...
	u':zusammengerollte_zeitung:': u'\U0001F5DE',
	u':pagemarker:': u'\U0001F4D1',
	u':lesezeichen:': u'\U0001F516',
	u':etikett:': u'\U0001F3F7',
	...
	u':urne_mit_wahlzettel:': u'\U0001F5F3',
	u':bleistift:': u'\U0000270F',
	u':schwarzer_federhalter:': u'\U00002712',
	u':füllhalter:': u'\U0001F58B',
	u':kugelschreiber:': u'\U0001F58A',
	...
	u':karteibahnen:': u'\U0001F5C2',
	u':kalender:': u'\U0001F4C5',
	u':abreißkalender:': u'\U0001F4C6',
	u':notizblock:': u'\U0001F5D2',
	...
	u':axt:': u'\U0001FA93',
	u':pickel:': u'\U000026CF',
	u':hammer_und_pickel:': u'\U00002692',
	...
	u':destillierapparat:': u'\U00002697',
	...
	u':pfeil_nach_oben:': u'\U00002B06',
	u':pfeil_nach_rechts_oben:': u'\U00002197',
	u':pfeil_nach_rechts:': u'\U000027A1',
	u':pfeil_nach_rechts_unten:': u'\U00002198',
	u':pfeil_nach_unten:': u'\U00002B07',
	u':pfeil_nach_links_unten:': u'\U00002199',
	u':pfeil_nach_links:': u'\U00002B05',
	u':pfeil_nach_links_oben:': u'\U00002196',
	u':pfeil_nach_oben_und_unten:': u'\U00002195',
	u':pfeil_nach_links_und_rechts:': u'\U00002194',
	u':geschwungener_pfeil_nach_links:': u'\U000021A9',
	u':geschwungener_pfeil_nach_rechts:': u'\U000021AA',
	u':geschwungener_pfeil_nach_oben:': u'\U00002934',
	u':geschwungener_pfeil_nach_unten:': u'\U00002935',
	...
	u':atomzeichen:': u'\U0000269B',
	u':om:': u'\U0001F549',
	u':davidstern:': u'\U00002721',
	u':dharma-rad:': u'\U00002638',
	u':yin_und_yang:': u'\U0000262F',
	u':römisches_kreuz:': u'\U0000271D',
	u':orthodoxes_kreuz:': u'\U00002626',
	u':hilal_und_stern:': u'\U0000262A',
	...
	u':wiedergabe:': u'\U000025B6',
	u':doppelpfeile_nach_rechts:': u'\U000023E9',
	u':nächster_titel:': u'\U000023ED',
	u':wiedergabe_oder_pause:': u'\U000023EF',
	u':pfeil_zurück:': u'\U000025C0',
	u':zurückspulen:': u'\U000023EA',
	u':vorheriger_titel:': u'\U000023EE',
	...
	u':pause:': u'\U000023F8',
	u':stopp:': u'\U000023F9',
	u':aufnehmen:': u'\U000023FA',
	u':auswerfen:': u'\U000023CF',
	...
	u':frauensymbol:': u'\U00002640',
	u':männersymbol:': u'\U00002642',
	u':symbol_für_transgender:': u'\U000026A7',
	u':multiplikationszeichen:': u'\U00002716',
	...
	u':ausrufe-_und_fragezeichen:': u'\U00002049',
	...
	u':abstimmungsfeld_mit_häkchen:': u'\U00002611',
	u':kräftiges_häkchen:': u'\U00002714',
	u':kreuzzeichen:': u'\U0000274C',
	u':kreuzsymbol_im_quadrat:': u'\U0000274E',
	u':schleife:': u'\U000027B0',
	u':doppelschleife:': u'\U000027BF',
	u':teilalternationszeichen:': u'\U0000303D',
	u':achtzackiger_stern:': u'\U00002733',
	u':stern_mit_acht_zacken:': u'\U00002734',
	u':funkeln:': u'\U00002747',
	u':copyright:': u'\U000000A9',
	u':registered-trademark:': u'\U000000AE',
	u':markenzeichen:': u'\U00002122',
	...
	u':großbuchstabe_a_in_rotem_quadrat:': u'\U0001F170',
	u':großbuchstaben_ab_in_rotem_quadrat:': u'\U0001F18E',
	u':großbuchstabe_b_in_rotem_quadrat:': u'\U0001F171',
	...
	u':schriftzeichen_sa:': u'\U0001F202',
	u':schriftzeichen_für_monatsbetrag:': u'\U0001F237',
	...
	u':schriftzeichen_für_gratulation:': u'\U00003297',
	u':schriftzeichen_für_geheimnis:': u'\U00003299',
	...
	u':mittelgroßes_schwarzes_quadrat:': u'\U000025FC',
	u':mittelgroßes_weißes_quadrat:': u'\U000025FB',
	u':mittelkleines_schwarzes_quadrat:': u'\U000025FE',
	u':mittelkleines_weißes_quadrat:': u'\U000025FD',
	u':kleines_schwarzes_quadrat:': u'\U000025AA',
	u':kleines_weißes_quadrat:': u'\U000025AB',
